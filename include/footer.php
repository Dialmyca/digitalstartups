            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 fnumber">
                        <p>Contact Number <br><span><a href="tel:+917971478657">+91 79714 78657</a></span></p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-12 fnumber">
                        <p>WhatsApp Number <br><span><a href="https://web.whatsapp.com/send?phone=+917971478657&amp;text=Hi, I would like to get more information.." class="whatsapplink hidemobile" target="_blank">+91 79714 78657</a></span></p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-12 fnumber">
            ...
            <div class="widgets-section">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-2 col-sm-2 p-md-0 pl-3">
                          ...
                          <div class="footer-widget text-md-left text-center">
                              <ul class="list-link pl-md-4 pl-0">
                                  <li class="d-block"><a href="#">Logo Designing</a></li>
                                  <li class="d-block"><a href="#">Graphic designing</a></li>
                                  <li class="d-block"><a href="#">Website Designing</a></li>
                                  <li class="d-block"><a href="#">Brochure Designing</a></li>
                                  <li class="d-block"><a href="#">Mobile Application</a></li>
                                  <li class="d-block"><a href="#">CRM Software</a></li>
                              </ul>
                          </div>
                    </div>
                    <div class="col-md-2 col-sm-2 p-md-0 pl-3">
                          ...
                          <div class="footer-widget links-widget text-md-left text-center">
                              <ul class="list-link pl-0">
                                  <li class="d-block"><a href="#">Digital Marketing</a></li>
                                  <li class="d-block"><a href="#">Domain Purchase</a></li>
                                  <li class="d-block"><a href="#">SSL Purchase</a></li>
                                  <li class="d-block"><a href="#">Web Hosting</a></li>
                                  <li class="d-block"><a href="#">Facebook Ad Campaign</a></li>
                                  <li class="d-block"><a href="#">Google Ad Campaign</a></li>
                              </ul>
                          </div>
                    </div>
                    <div class="col-md-3 col-sm-3 pl-3">
                        <div class="footer-widget links-widget text-md-left text-center pb-md-5">                  
                            <p><u><b>Head Office</b></u><br/>C/O DialMyCA Advisory Services (P) Ltd.<br/>57/2X, NSC Bose Road, Tollygunge,<br/> Kolkata - 700040,<br/> West Bengal<br/>India</p>
                        </div>
                         <div class="footer-widget links-widget text-md-left text-center">
                            <h5 class="join-us">Join With Us</h5>
                            <ul class="social-footer pl-0">
                                <li><a href="https://www.facebook.com/TaxSevaKendra.in/" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="https://twitter.com/tax_seva_kendra" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="https://instagram.com/taxsevakendra/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                    ...
                    <div class="col-md-9 col-sm-9 position-relative ftr-posi">
                        <div class="row">
                            <div class="col-md-4 col-sm-4 ftr-bdr pt-mb-3">
                                <div class="dgl-copyright text-md-left text-center pt-md-5">© 2021 DigitalStartups<br/> All Rights Reserved</div>
                            </div>
                            <div class="col-md-8 col-sm-8 ftr-bdr">
